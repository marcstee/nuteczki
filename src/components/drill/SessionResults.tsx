 ...
 * add a second line for letter→note without restructuring. A `saveState` prop
 * and retry affordance are added in P3 — keep the layout open to them.
 */
export default function SessionResults({ correct, incorrect, accuracyPct, onAgain, onDone }: Props) {
  return (
